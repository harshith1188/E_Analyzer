...
export default function Savings() {
  ...
  useFocusEffect(
    useCallback(()=>{
      ...
      if(lastMonthData){
        let parseddata=JSON.parse(lastMonthData);
         last_month_bill=Number(parseddata.finalbill);
      ...
      if(currentMonthData){
        ...
        console.log("currentmonth",parseddata);
  ...
  return (
    ...
    <ScrollView style={{flex:1}} contentContainerStyle={{alignItems:"center",justifyContent:"space-evenly",gap:30}}>
     ...
     <View style={styles.c2}>
        ...
        <View style={styles.c5_1}>
        <Text style={styles.h2}>natural light</Text>
        <Text style={styles.h3}>save up to $15</Text>
        <Text style={styles.h3}>per month</Text>  
        </View>  
